...
/**
 * Tests of the view that output is an enhanced svg format.
 */
public class EnhancedSVGViewTest {
  ...
  private void emptySpeed20() {
    ...
    view = new AnimationEnhancedSVGView(model, 20);
  }
  ...
  private void plusSpeed20() {
    try {
      reader = new BufferedReader(new FileReader("plus-sign.txt"));
      System.out.println(reader);
    } catch (FileNotFoundException e) {
      e.printStackTrace();
    }
  ...
  private void toh3Speed10() {
    ...
    builder = new SimpleAnimation.Builder();
    model = AnimationReader.parseFile(reader, builder);
    view = new AnimationEnhancedSVGView(model, 10);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullModel() {
    view = new AnimationEnhancedSVGView(null, 20);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testZeroSpeed() {
    IAnimation model = new SimpleAnimation();
    view = new AnimationEnhancedSVGView(model, 0);
  }
  ...
  public void testCanvasEmpty() {
    emptySpeed20();
    String tag = "<svg viewBox=\"0 0 360 360\" version=\"1.1\" "
  ...
  public void testCanvasToh3() {
    toh3Speed20();
    String tag = "<svg viewBox=\"145 50 410 220\" version=\"1.1\" "
        + "xmlns=\"http://www.w3.org/2000/svg\">";
    assertTrue(view.toString().contains(tag));
  }
  ...
  public void testCanvasToh5() {
    toh5Speed20();
    String tag = "<svg viewBox=\"145 50 410 208\" version=\"1.1\" "
        + "xmlns=\"http://www.w3.org/2000/svg\">";
    assertTrue(view.toString().contains(tag));
  }
  ...
  @Test
  public void testSpeed20Plus() {
    plusSpeed20();
    String disk2 = "<polygon id=\"disk1\" points=\"195,180 205,180 205,187 210,187 210,202 205,202"
        + " 205,210 195,210 195,202 190,202 190,187 195,187 \" fill=\"rgb(0,49,90)\">";
    assertTrue(view.toString().contains(disk2));
  }
