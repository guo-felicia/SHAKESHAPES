...
/**
 * A Animation Builder which help build and initialize the Simple animation model correspondingly.
 *
 * @param <Doc> the argument that use builder which need to modified by builder.
 */
public interface AnimationBuilder<Doc> {
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addSloMo(int start, int end);
